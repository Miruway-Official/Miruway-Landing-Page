...
const projects: Project[] = [
  {
    ...
    description: "Web AR image-tracking experience with marker-based image tracking and lead generation for Oligio's marketing campaign.",
  ...
  {
    id: 2,
    title: "Oligio Dashboard",
    category: "Admin Panel",
    description: "Staff and superadmin panel for coupon registration, QR code verification, and redemption tracking across campaign locations.",
  ...
  },
  {
    ...
    description: "REST API backend powering the Oligio campaign platform — coupon lifecycle, verification logic, and PostgreSQL persistence.",
    image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&q=80",
    tags: ["Elysia", "Bun", "Drizzle ORM", "Supabase"],
    year: "2026",
  },
  {
    id: 4,
