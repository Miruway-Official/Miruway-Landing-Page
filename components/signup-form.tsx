            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  required
                  className="bg-slate-950/50 border-white/10 text-white focus:border-pink-500"
                />
              </div>
              ...
              <Button type="submit" className="w-full bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white shadow-lg shadow-pink-900/20 font-bold">
                สมัครสมาชิก
              </Button>
